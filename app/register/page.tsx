...
import { Eye, EyeOff, ArrowRight, Phone, Mail, Check, Loader2 } from 'lucide-react'
...
export default function RegisterPage() {
  ...
  // ── Phone OTP — verify & create profile ──────────────────
      ...
      <main className="min-h-screen bg-brand-light pt-20">
        <div className="max-w-md mx-auto px-4 py-16">
          <div className="bg-white rounded-2xl shadow-card p-8 text-center">
            ...
            <h1 className="font-display text-3xl text-brand-dark mb-4">Almost there!</h1>
      ...
      <div className="max-w-md mx-auto px-4 py-16">
        <div className="bg-white rounded-2xl shadow-card p-8">
          ...
          <div className="text-center mb-8">
            <h1 className="font-display text-3xl text-brand-dark mb-2">Create Account</h1>
            <p className="text-brand-dark/60">Join our global marketplace</p>
          </div>
          ...
          <div className="flex items-center gap-3 mb-5">
            ...
            <span className="text-xs text-brand-dark/40 font-medium">or sign up with</span>
            <div className="flex-1 h-px bg-brand-dark/10" />
          </div>
          ...
          {tab === 'phone' && phoneStep === 'otp' && (
            <form onSubmit={handleVerifyOtp} className="space-y-5">
              ...
              <button
                ...
                className="w-full py-4 bg-brand-dark text-white rounded-xl font-medium hover:bg-brand-dark/90 transition-colors disabled:opacity-50 flex items-center justify-center gap-2"
              >
                {loading ? <Loader2 className="w-5 h-5 animate-spin" /> : <>Verify & Create Account <ArrowRight className="w-5 h-5" /></>}
              </button>
              <button
                type="button"
